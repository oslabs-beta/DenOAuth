...
export class GoogleStrategy extends GoogleGrant {
  ...
  createLink() {
    ...
    let SampleLink: String = `https://accounts.google.com/o/oauth2/v2/auth?scope=${this.client.config.scope}https://mail.google.com&access_type=offline&include_granted_scopes=true&response_type=code&state=${state}&redirect_uri=${encodeLink}&client_id=${this.client.config.clientId}`
    return SampleLink
  }
