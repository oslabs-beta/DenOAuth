...
export interface SpotifyClientConfig {
  ...
  // Our implementation currently only works with scope set to 'user-read-email' 
...
export class SpotifyClient {
  ...
  public code = new SpotifyStrategy(this);

  // interface values cannot be changed outside of class
  constructor(
    public readonly config: Readonly<SpotifyClientConfig>,
  ) {}
}